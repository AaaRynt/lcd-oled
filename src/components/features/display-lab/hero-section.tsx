...
export function HeroSection() {
  return (
    <section id="top" className="relative overflow-hidden">
      ...
      <div className="relative mx-auto grid max-w-300 min-w-0 gap-10 px-4 py-16 sm:px-6 md:py-24 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
        <div className="fade-in-up flex min-w-0 flex-col justify-center">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <a href="#comparison" className="inline-flex items-center justify-center gap-2 rounded-full bg-cyan-300 px-5 py-3 text-sm font-semibold text-zinc-950 transition hover:bg-cyan-200 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-cyan-300">
              查看核心差异
              <ArrowDown className="h-4 w-4" aria-hidden="true" />
            </a>
            <a href="#recommendation" className="inline-flex items-center justify-center gap-2 rounded-full border border-white/12 bg-white/7 px-5 py-3 text-sm font-semibold text-zinc-100 transition hover:border-fuchsia-300/50 hover:bg-fuchsia-300/10 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-fuchsia-300">
      ...
      <div className="relative mx-auto max-w-300 px-4 pb-14 sm:px-6 lg:px-8">
